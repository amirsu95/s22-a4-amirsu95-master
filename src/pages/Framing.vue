<template>
  <main class="framing-main">
    ...
    <form class="framing-form museum-label" @submit.prevent>
      ...
      <WidthSlider label="Frame" :max="50" :min="20" :value="config.frameWidth" v-model="config.frameWidth"></WidthSlider>
      <FrameStylePicker :value="config.frameStyle" v-model="config.frameStyle"></FrameStylePicker>
      <WidthSlider label="Mat" :max="100" :min="0" :value="config.matWidth" v-model="config.matWidth"></WidthSlider>
      <MatColorPicker v-model="config.matColor"></MatColorPicker>
      <fieldset>
        <legend>Price</legend>
